...
const Search = (props: itemType) => {
  return (
    <>
      <div className={"fixed top-0 left-16 h-screen rounded-r-xl bg-white shadow-[25px_0px_50px_rgba(0,0,0,0.1)] transition-all duration-1000 " + (props.search ? " w-[350px] border-l-2 " : " w-0 ") + (props.mobile && " hidden ")}>
