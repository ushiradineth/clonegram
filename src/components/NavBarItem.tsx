...
const NavBarItem = (props: itemType) => {
  ...
  return (
    <div id={props.ID} className={"flex cursor-pointer items-center justify-start p-2 hover:rounded-full " + (props.viewport == "Web" && " w-64 p-2 pl-3 ") + (props.theme.type === "dark" ? ` hover:${props.theme.secondary} ` : ` hover:${props.theme.tertiary} `)} onMouseEnter={() => setHover(true)} onMouseLeave={() => setHover(false)} onClick={props.onClickHandler}>
