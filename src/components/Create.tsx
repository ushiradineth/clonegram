...
const Create = (props: itemType) => {
  ...
  const Crop = () => {
    ...
    return (
      <div className={"absolute top-1/2 left-1/2 z-30 h-fit min-h-[200px] w-fit max-w-[450px] min-w-[200px] -translate-x-1/2 -translate-y-1/2 transform rounded-2xl " + data?.theme?.tertiary}>
