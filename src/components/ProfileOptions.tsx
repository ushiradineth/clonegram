...
const ProfileOptions = (props: itemType) => {
  ...
  return (
    <>
      {blockMenu && <OptionMenu title={`Block ${props.page.data.handle}?`} description="They won't be able to find your profile or posts." buttonPositive="Block" buttonNegative="Cancel" onClickPositive={blockFunc} onClickNegative={() => setBlockMenu(false)} />}
