  ...
  return (
    <div className="fixed top-0 left-0 z-50 h-screen w-screen bg-black bg-opacity-30">
      <div className={"absolute top-1/2 left-1/2 z-20 h-auto w-[300px] -translate-x-1/2 -translate-y-1/2 transform rounded-2xl shadow-[0px_0px_10px_rgba(0,0,0,0.7)] md:w-[400px] " + props.theme.tertiary}>
        <div className="w-full flex flex-col items-center justify-center border-b-[1px] border-gray-300 py-8 font-semibold">
          <p className="select-none">{props.title}</p>
          <p className="text-sm font-normal text-center px-4">{props.description}</p>
        </div>
